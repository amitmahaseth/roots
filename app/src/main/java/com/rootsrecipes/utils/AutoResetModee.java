...
/**
 * Describes how the {@link ZoomY} will reset to its original size
...
@IntDef({AutoResetModee.NEVER, AutoResetModee.UNDER, AutoResetModee.OVER, AutoResetModee.ALWAYS})
public @interface AutoResetModee {
